...
4. **"Vacuum Truck Services for Your Home"** — intro paragraphs, then alternating photo/text split blocks for Septic Tank Pumping & Cleaning, Holding Tank Pumping, Emergency Septic Pumping (highlighted alert-style panel), Drain & Sewer Cleaning, Video Pipe Inspection, each with its buttons where supplied.
